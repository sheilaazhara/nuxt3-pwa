<template>
    <BaseContainer>
        ...
        <div class="mt-6 grid gap-y-6 gap-x-6 grid-cols-2">
            <div v-for="product in products" :key="product.id" class="group relative border rounded-md p-2">
                <div class="overflow-hidden rounded-md group-hover:opacity-75">
                    <img :src="product.image" :alt="product.title" class="h-32 w-32 object-cover object-center mx-auto" />
                </div>
